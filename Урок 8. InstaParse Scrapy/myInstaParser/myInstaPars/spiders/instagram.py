...
class InstsgramSpider(scrapy.Spider):
    name = 'instagram'
    allowed_domains = ['instagram.com']
    start_urls = ['https://www.instagram.com/']
    inst_login_link = 'https://www.instagram.com/accounts/login/ajax/'
    # inst_login = 'supersirius_sa'
    # inst_passwd = '#PWD_INSTAGRAM_BROWSER:10:1654609031' \
    #              ':AbJQAFmss930L6Usl6UVpNtTHFhY4HWImNTVX4DRQD+cu3s9jFd8MCSScVOBSkfd08OMs1TxsYgDlZ0jX4FXifonXGZtok2TO2b78PLa925pQe+AKop8rJPBajIVTj9CeVZPMEYCWEbE+w=='
    ...
    parse_users = ['supersirius_sa', 'ns_kosareva']
